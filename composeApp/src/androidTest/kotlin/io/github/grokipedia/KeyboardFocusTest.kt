...
class KeyboardFocusTest {
    ...
    fun keyboardOpens_AndInputCanReceiveText() {
        ...
        val isKeyboardShowing = device.wait(Until.findObject(By.pkg("com.google.android.inputmethod.latin")), 1000) != null ||
                                 device.wait(Until.findObject(By.res("com.google.android.inputmethod.latin:id/keyboard_view")), 1000) != null
